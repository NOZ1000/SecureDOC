    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        ...
        <div class="sm:col-span-6 md:col-span-3 lg:col-span-2">
          ...
          <ul class="text-sm">
            <li class="mb-2">
              <router-link to="#" class="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Documents</router-link>
            </li>
          </ul>
        </div>
      ...
      <div class="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
        ...
        <!-- Copyrights note -->
        <div class="text-sm text-gray-600 mr-4">&copy; SecureDOC.com</div>
